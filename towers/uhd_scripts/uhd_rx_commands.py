...
def uhdRxCommands():
	...
	parser.add_argument('--gain', action='store', help='gain', type=int,default=25)
...
if __name__ =="__main__":
	...
	for segment in band_segments:
		...
		filename = QI_DATA_DIR+'/'+str(stamp)+'_'+segment.band.replace(' ','_')+'_'+str(int(round(segment.c_freq,3)*1000000))+'.32fc'
	...
	filemap_to_csv(band_segments,STREAM_FILE_MAP)
